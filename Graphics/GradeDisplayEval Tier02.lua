local t = Def.ActorFrame {
	...
	OnCommand=function(self)
		self:zoomy(10):diffusealpha(0):sleep(2.3):linear(0.1):zoomy(1):diffusealpha(1)
	end;
	};
	...
	OnCommand=function(self)
		self:zoomy(10):diffusealpha(0):sleep(2.4):linear(0.1):zoomy(1):diffusealpha(1)
	end;
	};
	Def.Sprite {
