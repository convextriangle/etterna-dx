local t = Def.ActorFrame {
	...
	LoadActor("ILINE2.png") .. {
		...
		OnCommand = function(self)
			self:cropleft(1):croptop(1):sleep(0.2):linear(.1):cropleft(0.98):croptop(.995):linear(.2):croptop(0):linear(.2)
				:cropleft(0)
		end,
	},
	-- [Layer13]
	LoadActor("ILINE3.png") .. {
		...
		OnCommand = function(self)
			self:cropright(1):croptop(1):sleep(0.2):linear(.1):cropright(0.98):croptop(.995):linear(.2):croptop(0)
				:linear(.2):cropright(0)
		end,
	},
	-- [Layer14]
